...
const navBaseStyle = `px-4 block pt-3 pb-1 hover:bg-purple-600`;
const isNavActive = (isActive: any) => `${navBaseStyle}` + (isActive ? ' bg-purple-600' : '');

const Header = () => {
  return (
    <header className="w-full h-[50px] bg-purple-700 flex justify-between items-end text-white px-4">
